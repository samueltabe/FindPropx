    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/house/update/'. $house->id) }}" method="Post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                       <div class="row py-3">
                            <div class="col-md-6">
                       ...
                       <div class="row py-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $house->area }}" class="form-control" name="area" placeholder="Sqft">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                       ...
                       <div class="row py-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label for="image" class="image">Enter Video Link</label>
                                <input type="text" name="video"  id="video" accept="video/*" class="form-control">
                            </div>
                        </div>
                       </div>
                       <div class="row py-3">
