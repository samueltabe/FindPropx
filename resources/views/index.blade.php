                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="tabs_1">
                                        <div class="rld-main-search">
                                            <div class="row">
                                                <div class="col-md-2 rld-single-input">
                                                    <input type="text" placeholder="Enter Keyword...">
                                                </div>
                                                <div class="col-md-3 rld-single-select ml-22">
                                                ...
                                                <div class="col-md-3 rld-single-select">
                                                ...
                                                <div class="col-md-2 rld-single-select">
            ...
            <div class="item col-xl-6 col-lg-12 col-md-12 col-xs-12 landscapes sale">
                <div class="project-single" data-aos="fade-right">
                    <div class="project-inner project-head">
                        <div class="homes">
                            <!-- homes img -->
                            <a href="{{ url('single/'.$house->id) }}" class="homes-img" style="height: 400px">
        ...
        <div class="row service-1">
            ...
            <article class="col-lg-3 col-md-6 col-xs-12 serv mb-0 pt" data-aos="fade-up" data-aos-delay="350">
                <div class="serv-flex arrow">
                    ...
                    <div class="service-text-p">
                        <p class="text-center">
                            Findpropx employs advanced
                            encryption and security measures to protect your personal and financial information.
                        </p>
                    </div>
                </div>
            </article>
