                                ...
                                <div class="card card-default card-fill">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="about-info-p my-1">
                                                    <strong>Image</strong>
                                                    <br>
                                                    <img src="{{ asset('upload/admin/images/'.auth::user()->image) }}" class="rounded-circle" width="70px" height="70px" alt="user image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div class="card-body">
                                <form action="{{ route('profileUpdate') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('upload/admin-dp/'.auth::user()->image) }}" width="50px" height="40px" class="my-2" alt="image">
